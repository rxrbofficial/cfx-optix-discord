...
AddEventHandler('Boost-Discord:SetPresence', function(data)
	...
	SetDiscordRichPresenceAsset('presence') --Main Logo Name 
	SetDiscordRichPresenceAssetSmall('verified')  -- Small Badge Text
	...
	SetDiscordRichPresenceAssetText('Change Me') -- Main Logo Text
	SetDiscordRichPresenceAssetSmallText('Badge Text') -- Badge Text
end)
